...
BODY_PL = ['fat people','skinny people','muscular people', 'thin people',
           'larger people','tall people','short people','stout people']
NATIONALITY_PL = ['the Japanese','the English', "Germans","Romanians"]
phrases = {'AGE+GENDER-PL':GENDERAGE_PL,'GENDER-PL':GENDER_PL,
           'GENDER-POSS':GENDER_POSS,
           'BODY-HAIRCOLOR-PL':HAIRCOLOR_PL,'HAIRCOLOR-MOD':HAIRCOLOR,
           'CLOTHING-HEAD-PL':CLOTHING_HEAD_PL,
           'AGE-PL':AGE_PL,'BODY-PL':BODY_PL,'NATIONALITY-PL':NATIONALITY_PL}
